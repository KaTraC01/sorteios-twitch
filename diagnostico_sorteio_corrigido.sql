-- Script de diagnóstico para problema de sorteios não registrados (CORRIGIDO)
...
-- 5. Verificar se há atividade recente (método alternativo sem usar xmin)
SELECT 
...
UNION ALL
SELECT 
    'participantes_ativos' as table_name,
    COUNT(*) as total_registros,
    MAX(created_at) as ultimo_registro
FROM participantes_ativos
UNION ALL
SELECT 
    'historico_participantes' as table_name,
    COUNT(*) as total_registros,
    MAX(created_at) as ultimo_registro
